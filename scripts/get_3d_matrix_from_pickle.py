      ...
      for file in files:
        ...
        with open(file, 'rb') as out:
          ...
          for key in keys:
            ...
            np.save(path+'/'+title+'_x_mean_loc', p[key]['x_mean_loc_im3d'])
            np.save(path+'/'+title+'_y_mean_loc', p[key]['y_mean_loc_im3d'])
            np.save(path+'/'+title+'_z_mean_loc', p[key]['z_mean_loc_im3d'])
            ...
            np.save(path+'/'+title+'_x_mean_loc', p[key]['x_mean_loc_depth_im3d'])
            np.save(path+'/'+title+'_y_mean_loc', p[key]['y_mean_loc_depth_im3d'])
            np.save(path+'/'+title+'_z_mean_loc', p[key]['z_mean_loc_depth_im3d'])
            ...
            np.save(path+'/'+title+'_x_mean_loc', p[key]['x_mean_loc_'+str(key)+'_segmask'])
            np.save(path+'/'+title+'_y_mean_loc', p[key]['y_mean_loc_'+str(key)+'_segmask'])
            np.save(path+'/'+title+'_z_mean_loc', p[key]['z_mean_loc_'+str(key)+'_segmask'])
            ...
            np.save(path+'/'+title+'_x_mean_loc', p[key]['x_mean_loc_K'])
            np.save(path+'/'+title+'_y_mean_loc', p[key]['y_mean_loc_K'])
            np.save(path+'/'+title+'_z_mean_loc', p[key]['z_mean_loc_K'])
